...
/*
 * validado dia 04/11/2024 com esp32 dev kit v1 original e sensor jsn-sro4 e funcionando normalmente
 */
...
#define BLYNK_AUTH_TOKEN "_drkwZR238VCOMjqDbxE0KtrJ4MP2AKi" // juvenil.lima2040 / Juvenil.1952
#define OTA_HOSTNAME "Maetinga-001-2" // Caixa dágua principal casa do pai
...
int vinte     = 15;
/*
#define TRIGGER D1  //pino externo esp01
#define ECHO    D2  //pino interno esp01
int LED       = D4; //= D4;
int cem       = D8;
int oitenta   = D7;
int sessenta  = D6;
...
char pass[] = "987652017";                //WiFi Password
...
void loop() 
{
  ...
  Blynk.virtualWrite(V6, distance); // V6 Distância para chegar no fundo
 ...
 if (distance <= 60) 
 {
  ...
  Blynk.virtualWrite(V5, distance); // V5 = Distância para chegar no cheio
  delay(150);
