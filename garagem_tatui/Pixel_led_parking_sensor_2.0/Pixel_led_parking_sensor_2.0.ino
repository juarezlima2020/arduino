...
#define N_LEDS      25    //adjust this number to reflect the number of LEDs in your LED strip
#define PIN         10
const int trigPin = 12;
const int echoPin = 11;

int offThreshhold =   180; //turn lights to red    (Vermelho - 200)90  -140 
int closeThreshhold = 150; //turnlights to yellow  (Amarelo  - 180)120 -110 
int safeThreshhold =  120; //turn lights to green  (Verde    - 120)180 - 80
int tooClose =         90; //turn lights to purple (Roxo     -  90)150 - 50
int stop =             60; //flashes warning lights(Pisca    -  60)60  - 20
...
uint32_t purple = strip.Color(200, 5, 150);  //03 - purple  ->02--(200, 5, 150);
uint32_t red = strip.Color(255, 0, 0);       //red
uint32_t green = strip.Color(0, 255, 0);     //02 - green   ->01--(0, 255, 0);
uint32_t blue = strip.Color(0, 0, 255);      //blue
uint32_t yellow = strip.Color(170, 200, 0);  //01 - amarelo 03--(170, 200, 0);
