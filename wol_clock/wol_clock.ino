...
const RGB Twelve = { 128, 0, 128 }; //roxa clara
...
const RGB Background = { 1, 3, 10 };//preto
...
const TIME WeekNight = {21, 30};     // A noite vai escurecer
const TIME WeekMorning = {6, 15};    // Manhã hora de ir brilhante
const TIME WeekendNight = {21, 30};  // A noite vai escurecer
const TIME WeekendMorning = {9, 30}; // Manhã hora de ir brilhante

const int day_brightness = 255;
const int night_brightness = 16;

//Defina seu fuso horário em horas de diferença rom GMT
...
#define PIN            2 // 14 This is the D5 pin /-\ esp01 = 2
