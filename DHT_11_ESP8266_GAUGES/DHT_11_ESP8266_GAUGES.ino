...
const char* ssid =     "JPL";     // Set your router SSID
const char* password = "123@juarez"; // Set your router password
...
int    PageRefreshPeriod  = 30;  // Period of web page refresh in seconds
